...
class MyNavigatorPushPage extends MyStatefulWidget {
  MyNavigatorPushPage({String name, Key key, this.title = "State hold Navigator Page#1"})
...
class _MyNavigatorPushPageState extends MyState<MyNavigatorPushPage> {
  ...
  void _incrementCounter() {
    ...
    */
    ...
    debugPrint(" \n$name  _incrementCounter, name=${widget.name}, widget=${widget.hashCode}:${widget.runtimeType.toString()}, _counter=${MyPage1InheritedWidget.getLogic(context).counter}");
    setState(() {
      MyPage1InheritedWidget.getLogic(context).increment();
    });
  }
        ...
        child: MyColumn(
          ...
          children: <Widget>[
            ...
            MyCounterStatelessComponent(
                name: "[#1]", parameter: MyPage1InheritedWidget.getLogic(context).counter,
...
class MyNavigatorPushPopPage extends MyStatefulWidget {
  MyNavigatorPushPopPage({String name, Key key, this.title: "State hold Navigator Page#2"})
...
class _MyNavigatorPushPopPageState extends MyState<MyNavigatorPushPopPage> {
  ...
  void _incrementCounter() {
    ...
    */
    ...
    debugPrint(" \n$name  _incrementCounter, name=${widget.name}, widget=${widget.hashCode}:${widget.runtimeType.toString()}, _counter=${MyPage2InheritedWidget.getLogic(context).counter}");
    setState(() {
      MyPage2InheritedWidget.getLogic(context).increment();
    });
  }
      ...
      body: MyContainer(
        ...
        child: MyColumn(
          ...
          children: <Widget>[
            ...
            // カウンター表示部のコンポーネント
            MyCounterStatelessComponent(name: "[#2]", parameter: MyPage2InheritedWidget.getLogic(context).counter,
                outerColor: Colors.blue, innerColor: Colors.lightBlue),
              ...
              onPressed: () {
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute<void>(
                      builder: (BuildContext context) {
                        // PageRoute 下の InheritedWidget は、他のPageRouteを参照できません。
                        return MyPage3InheritedWidget(child: MyNavigatorPopPage());
                      }
                  ),
                );
              },
...
class MyNavigatorPopPage extends MyStatefulWidget {
  MyNavigatorPopPage({String name, Key key, this.title: "State hold Navigator Page#3"})
...
class _MyNavigatorPopPageState extends MyState<MyNavigatorPopPage> {
  ...
  void _incrementCounter() {
    ...
    */
    ...
    debugPrint(" \n$name  _incrementCounter, name=${widget.name}, widget=${widget.hashCode}:${widget.runtimeType.toString()}, _counter=${MyPage3InheritedWidget.getLogic(context).counter}");
    setState(() {
      MyPage3InheritedWidget.getLogic(context).increment();
    });
  }
      ...
      body: MyContainer(
        ...
        child: MyColumn(
          ...
          children: <Widget>[
            ...
            // カウンター表示部のコンポーネント
            MyCounterStatelessComponent(
                name: "[#3]", parameter: MyPage3InheritedWidget.getLogic(context).counter,
                outerColor: Colors.blue, innerColor: Colors.lightBlue),
...
class MyAppInheritedWidget extends MyLogicInheritedWidget {
  ...
  // ページ１〜３のロジック
  final _page1Logic = new MyPageLogic();
  final _page2Logic = new MyPageLogic();
  final _page3Logic = new MyPageLogic();
