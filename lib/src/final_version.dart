...
class MyNavigatorPushPage extends MyStatefulWidget {
  MyNavigatorPushPage({String name, Key key, this.title = "Finel Version Page#1"})
...
class MyNavigatorPushPopPage extends MyStatefulWidget {
  MyNavigatorPushPopPage({String name, Key key, this.title: "Finel Version Page#2"})
...
class MyNavigatorPopPage extends MyStatefulWidget {
  MyNavigatorPopPage({String name, Key key, this.title: "Finel Version Page#3"})
